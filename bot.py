...
def admin_menu():
    ...
    for uid, info in users.items():
        buttons.append([
            InlineKeyboardButton(f"{info['name']}", callback_data=f"user_{uid}")
        ])
